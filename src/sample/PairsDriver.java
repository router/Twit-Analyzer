...
public class PairsDriver {
	...
	private static final transient Logger LOG = LoggerFactory.getLogger(PairsDriver.class);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setMapOutputKeyClass(PairsKey.class);
		job.setMapOutputValueClass(IntWritable.class);
		job.setNumReduceTasks(3);
		job.setPartitionerClass(PairsPartitioner.class);
		
		//job.setSortComparatorClass(PairsSort.class);
		//job.setCombinerClass(PairsCombiner.class);
		
		job.setReducerClass(PairsReducer.class);
		job.setOutputKeyClass(PairsKey.class);
